...
const BuyContact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs.sendForm('service_5dfudlk', 'template_1auqkvs', form.current, 's2JMah9F8HqJXd99w')
      .then((result) => {
  ...
  return (
    <>
      ...
      <div className="container my-5  overflow-hidden">
        <h1 className='text-center my-5 '><span  className=" contact-font">Buy Now</span></h1>
        ...
        <div id="contactForm" className="d-flex flex-lg-row flex-md-column flex-sm-column flex-column gap-5">
          {/* <div className="w-100">
