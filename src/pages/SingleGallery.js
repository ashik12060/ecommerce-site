...
const SingleGallery = () => {
    ...
    const displaySingleGallery = async () => {
        ...
        try {
            // 
            const { data } = await axiosInstance.get(`${process.env.REACT_APP_API_URL}/api/gallery/${id}`);
            // console.log(data)
    ...
    const addComment = async (e) => {
        e.preventDefault();
        try {
            const { data } = await axiosInstance.put(`${process.env.REACT_APP_API_URL}/api/comment/gallery/${id}`, { comment });
            ...
            <div className="container singlepro-bg">
              <div className="row">
                ...
                <div className="col-lg-9 col-md-9 col-sm-12 mt-3">
                  <p>
                    <b>Details:</b> Lorem Ipsum is simply dummy text of the printing
